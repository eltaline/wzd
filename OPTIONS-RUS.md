...
srchcache
- **Описание:** Глобально задает размер кеша поиска (мегабайты). Значения больше 1/1024 размера кеша не помещаются в кеш. Не настраивается для виртуального хоста.
- **Умолчание:** 128
- **Значения:** 1-1048576
- **Тип:** int
- **Секция:** [global]
...
getrecursive
- **Описание:** Если отключено, тогда рекурсивный поиск имен файлов или ключей будет запрещен (в том числе отдельных файлов).
- **Умолчание:** Обязательный параметр
- **Значения:** true или false
- **Тип:** bool
- **Секция:** [server.name]
