...
compaction
- **Описание:** Включает или отключает автоматическое добавление задач для диспетчера компакции/дефрагментации Bolt архивов, при обновлении или удалении файлов, или значений в Bolt архивах, если параметер cmpsched не отключен глобально.
- **Умолчание:** Обязательный параметр
- **Значения:** true или false
- **Тип:** bool
- **Секция:** [server.name]
