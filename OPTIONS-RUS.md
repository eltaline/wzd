...
- **Описание:** параметры выбора технической базы данных(мало данных). Достаточно sqlite
- **Умолчание:** sqlite
- **Значения:** sqlite/pgsql/mysql
- **Секция:** [global]


- dbdriver = "sqlite"                   # тип базы
- dbfile = "/var/lib/wzd/wzd.sqlite3"   # путь к sqlite db файлу
- dbhost = "127.0.0.1"                  # pgsql/mysql host/ip адрес
- dbport = 5432                         # pgsql/mysql tcp порт
- dbname = "wzd"                        # pgsql/mysql db имя
- dbuser = "wzd"                        # pgsql/mysql db пользователь
- dbpass = "wzd    "                    # pgsql/mysql db пароль
- dbconn = 8                            # количество открытых соединений кpgsql/mysql. 16 более чем достаточно
...
cmpcount = 100 
- **Описание:** счетчик обновленных файлов/значений в каждом bolt архиве. Если превышено, то диспетчер автоматической компакции запустит компакцию данного bolt архива (количество изменений)
- **Умолчание:** 30
- **Значения:** 1-10000
- **Тип:** int
- **Секция:** [global]
...
- medbuffer = 67042304 # средний буфер памяти, при превышении данного значения используется малый буфер памяти
- bigbuffer = 536338432 # не совсем буфер памяти, при превышении данного значения используется средний буфер памяти
