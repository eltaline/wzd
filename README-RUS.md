...
wZD это сервер написанный на языке Go, использующий модифицированную версию BoltDB баз,
...
- В комплекте предлагается многопоточный архиватор wZA для миграции файлов без остановки сервиса.
...
- Операционные системы 64 Bit Linux/FreeBSD.
...
Все ENV параметры по умолчанию тут: <a href=/Dockerfile>Dockerfile</a>
...
Для этого в компекте с wZD сервером идет архиватор wZA.
