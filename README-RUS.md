...
- Не рекомендуется загружать 100000+ файлов в одну директорию/один Bolt архив, это будет оверхед.
...
- ~~Отказ от sqlite/mysql/pgsql в пользу более простого решения (отказ от CGO).~~ (Сделано)
